...
public class Playlist_2511533021 {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);
        ArrayList<Musik_2511533021> playlist = new ArrayList<>();
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    Musik_2511533021 lagu = new Musik_2511533021(judul, penyanyi, durasi);
                    playlist.add(lagu);
