...
public class InsertionGUI_2511533021 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					InsertionGUI_2511533021 frame_3021 = new InsertionGUI_2511533021();
	 ...
	 * Create the frame.
	 */
	public InsertionGUI_2511533021() {
	...
	private void setArrayFromInput_3021() {
		...
		try {
			...
			for (int k_3021 = 0; k_3021 < parts_3021.length; k_3021++) {
				array_3021[k_3021] = Integer.parseInt(parts_3021[k_3021].trim());
			}
		...
		for (int k_3021 = 0; k_3021 < array_3021.length; k_3021++) {
			labelArray_3021[k_3021] = new JLabel(String.valueOf(array_3021[k_3021]));
			labelArray_3021[k_3021].setFont(new Font("Arial", Font.BOLD, 24));
			labelArray_3021[k_3021].setBorder(BorderFactory.createLineBorder(Color.BLACK));
			labelArray_3021[k_3021].setPreferredSize(new Dimension(50, 50));
			labelArray_3021[k_3021].setHorizontalAlignment(SwingConstants.CENTER);
